...
eventWeightDict = {
    ...
    ET_EVENT_TYPE_EAT               : ET_EVENT_WEIGHT_2,
    ET_EVENT_TYPE_WAKE              : ET_EVENT_WEIGHT_2,
    ET_EVENT_TYPE_SLEEP             : ET_EVENT_WEIGHT_2,
    ET_EVENT_TYPE_SHOWER            : ET_EVENT_WEIGHT_2,
    ET_EVENT_TYPE_MOVE_TO_KITCHEN   : ET_EVENT_WEIGHT_2,
    ET_EVENT_TYPE_MOVE_TO_BEDROOM   : ET_EVENT_WEIGHT_2,
    ET_EVENT_TYPE_MOVE_TO_HALLWAY   : ET_EVENT_WEIGHT_2,
    ET_EVENT_TYPE_MOVE_TO_TOILET    : ET_EVENT_WEIGHT_2,

    ET_EVENT_TYPE_EXERCISE          : ET_EVENT_WEIGHT_1,
    ET_EVENT_TYPE_CONVERSATION      : ET_EVENT_WEIGHT_1,
    ET_EVENT_TYPE_MORAL_SUPPORT     : ET_EVENT_WEIGHT_1,
    ET_EVENT_TYPE_RELATIVE          : ET_EVENT_WEIGHT_1,
    ET_EVENT_TYPE_FRIEND            : ET_EVENT_WEIGHT_1,
    ET_EVENT_TYPE_MEDICATION        : ET_EVENT_WEIGHT_1,
    ET_EVENT_TYPE_ENTERTAINMENT     : ET_EVENT_WEIGHT_1,
    ET_EVENT_TYPE_COMPANIONSHIP     : ET_EVENT_WEIGHT_1,
