...
int getEventWeight(int eventType) {
    switch(eventType){
        ...
        case EVENT_TRIGGER_EVENT_TYPE_EAT:              return EVENT_TRIGGER_WEIGHT_5;
        case EVENT_TRIGGER_EVENT_TYPE_SHOWER:           return EVENT_TRIGGER_WEIGHT_5;
        case EVENT_TRIGGER_EVENT_TYPE_WAKE:             return EVENT_TRIGGER_WEIGHT_5;
        case EVENT_TRIGGER_EVENT_TYPE_SLEEP:            return EVENT_TRIGGER_WEIGHT_5;
        case EVENT_TRIGGER_EVENT_TYPE_MOVE_TO_KITCHEN:  return EVENT_TRIGGER_WEIGHT_5;
        case EVENT_TRIGGER_EVENT_TYPE_MOVE_TO_BEDROOM:  return EVENT_TRIGGER_WEIGHT_5;
        case EVENT_TRIGGER_EVENT_TYPE_MOVE_TO_HALLWAY:  return EVENT_TRIGGER_WEIGHT_5;
        case EVENT_TRIGGER_EVENT_TYPE_MOVE_TO_TOILET:   return EVENT_TRIGGER_WEIGHT_5;

        case EVENT_TRIGGER_EVENT_TYPE_EXERCISE:         return EVENT_TRIGGER_WEIGHT_3;
        case EVENT_TRIGGER_EVENT_TYPE_CONVERSATION:     return EVENT_TRIGGER_WEIGHT_3;
        case EVENT_TRIGGER_EVENT_TYPE_MORAL_SUPPORT:    return EVENT_TRIGGER_WEIGHT_3;
        
        case EVENT_TRIGGER_EVENT_TYPE_FRIEND:           return EVENT_TRIGGER_WEIGHT_2;
        case EVENT_TRIGGER_EVENT_TYPE_RELATIVE:         return EVENT_TRIGGER_WEIGHT_2;
        case EVENT_TRIGGER_EVENT_TYPE_MEDICATION:       return EVENT_TRIGGER_WEIGHT_2;
        case EVENT_TRIGGER_EVENT_TYPE_ENTERTAINMENT:    return EVENT_TRIGGER_WEIGHT_2;
        case EVENT_TRIGGER_EVENT_TYPE_COMPANIONSHIP:    return EVENT_TRIGGER_WEIGHT_2;

        case EVENT_TRIGGER_EVENT_TYPE_ILL:              return EVENT_TRIGGER_WEIGHT_0;
        case EVENT_TRIGGER_EVENT_TYPE_VERY_ILL:         return EVENT_TRIGGER_WEIGHT_0;
