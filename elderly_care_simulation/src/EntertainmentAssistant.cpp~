...
int main(int argc, char **argv) {
    ...
    // Declare publishers
    ros::Publisher stagePub = n.advertise<geometry_msgs::Twist>("robot_1/cmd_vel", 1000); 

    // Declare subscribers
    ros::Subscriber stageOdoSub = n.subscribe<nav_msgs::Odometry>("robot_1/odom", 1000, stageOdomCallback);
    ros::Subscriber taskSub = n.subscribe<elderly_care_simulation::Task>("task_request", 1000, taskRequestCallback);
