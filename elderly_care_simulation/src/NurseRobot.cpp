...
int main(int argc, char **argv) {   
    ...
    nurseRobot.robotNodeStagePub = nodeHandle.advertise<geometry_msgs::Twist>("robot_6/cmd_vel",1000);
    ...
    nurseRobot.stageOdoSub = nodeHandle.subscribe<nav_msgs::Odometry>("robot_6/base_pose_ground_truth",1000,
    ...
    nurseRobot.locationInstructionsSub = nodeHandle.subscribe<geometry_msgs::Point>("robot_6/location", 1000,
                                        callUpdateDesiredLocationCallback);
    nurseRobot.pathToRobotSub = nodeHandle.subscribe<std_msgs::Empty>("robot_6/toResident", 1000, callGoToResident);
    nurseRobot.pathToHomeSub = nodeHandle.subscribe<std_msgs::Empty>("robot_6/toHome", 1000, callGoToHome);
