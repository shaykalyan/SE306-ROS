...
/**
 * Prompt Entertainment robot to travel to the resident
 */
void Entertainment::goToResident(const std_msgs::Empty) {
...
/**
 * Prompt Entertainment robot to return back to its home POI
 */
void Entertainment::goToHome(const std_msgs::Empty) {
 ...
 * for the scheduler
 */
void Entertainment::eventTriggerReply() {
 ...
 */
void Entertainment::eventTriggerCallback(elderly_care_simulation::EventTrigger msg)
{
 ...
 */
void Entertainment::performTask() {
...
Entertainment entertainmentRobot;
...
void updateResidentPositionCallback(const nav_msgs::Odometry msg) {
    ...
    entertainmentRobot.residentPoi = StaticPoi(x+1, y, 0);
}
...
int main(int argc, char **argv) {   
    ...
    entertainmentRobot.robotNodeStagePub = nodeHandle.advertise<geometry_msgs::Twist>("robot_3/cmd_vel",1000);
    ...
    entertainmentRobot.stageOdoSub = nodeHandle.subscribe<nav_msgs::Odometry>("robot_3/base_pose_ground_truth",1000,
    ...
    entertainmentRobot.locationInstructionsSub = nodeHandle.subscribe<geometry_msgs::Point>("robot_3/location", 1000,
                                        callUpdateDesiredLocationCallback);
    entertainmentRobot.pathToRobotSub = nodeHandle.subscribe<std_msgs::Empty>("robot_3/toResident", 1000, callGoToResident);
    entertainmentRobot.pathToHomeSub = nodeHandle.subscribe<std_msgs::Empty>("robot_3/toHome", 1000, callGoToHome);
